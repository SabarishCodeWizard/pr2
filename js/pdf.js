    ...
    static async saveAsPDF() {
        ...
        try {
            ...
            if (window.electronAPI) {
                ...
                const htmlContent = PDFGenerator.generateHTMLContent(invoiceData, totalReturns, adjustedBalanceDue);
...
static getImageBase64() {
    ...
    static generateHTMLContent(invoiceData, totalReturns = 0, adjustedBalanceDue = 0) {
